...
// 1. 터미널에서 'flutter pub add google_generative_ai' 실행 필요
...
class _AIChatPageState extends State<AIChatPage> {
  ...
  void _sendMessage() {
    ...
    setState(() {
      ...
      // 여기에 API 호출 로직을 넣을 예정입니다.
      _messages.add({"role": "ai", "text": "생각 중입니다..."});
    });
    _controller.clear();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Text("PtoJ AI 비서"), backgroundColor: Colors.white),
      body: Column(
        children: [
          Expanded(
